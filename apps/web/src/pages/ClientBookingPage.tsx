      ...
      <div className="w-full max-w-[1180px] shadow-2xl rounded-3xl overflow-hidden my-8 border border-[#E2E8F0] bg-white">
        ...
        <div className="p-[30px_40px_40px] grid grid-cols-[1fr_348px] gap-[28px] items-start bg-[#FCFDFE]">
          ...
          <div className="sticky top-[24px] rounded-[22px] bg-white border border-[#E2E8F0] shadow-[0_12px_34px_rgba(15,23,42,.09)] overflow-hidden space-y-4">
            <div className="p-[16px_22px]" style={{ backgroundColor: primaryColor }}><span className="text-[9px] font-black text-white/75 tracking-[0.2em] uppercase block">SESSION SUMMARY</span><h3 className="text-[17px] font-bold text-white mt-0.5">{selectedService?.title || 'Select a service'}</h3></div>
            ...
            <div className="p-[0_22px_22px] space-y-3">
              ...
              <p className="text-[11.5px] text-[#94A3B8] font-medium text-center">Free cancellation up to 24 hours before</p>
            </div>
            <div className="p-[14px_22px] bg-[#F8FAFC] border-t border-[#E2E8F0] flex items-center gap-2 justify-center"><span className="text-[10.5px] font-semibold text-[#94A3B8]">Booking powered by</span><span className="text-[10.5px] font-extrabold text-brand-primary">UnclutterOS</span></div>
          </div>
        </div>
      </div>
    </div>
