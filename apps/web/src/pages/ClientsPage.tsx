...
import { Eyebrow, Card, StatusBadge, AvatarChip } from '@unclutteros/ui';
    ...
    <div className="flex-1 min-w-[1192px] flex flex-col bg-[#F8FAFC]">
      ...
      <header className="h-[80px] bg-white border-b border-[#E2E8F0] px-[26px] flex items-center justify-between gap-5 shrink-0">
        <div>
          ...
          <h1 className="text-[20px] font-bold tracking-[-0.02em] text-[#0F172A]">Clients</h1>
        </div>

        <div className="flex items-center gap-3 ml-auto">
          {/* Search Input */}
          <div className="h-[40px] bg-[#F1F5F9] border border-[#E2E8F0] rounded-[14px] px-3 flex items-center gap-2 w-[220px]">
          ...
          <button className="h-[40px] px-4 rounded-[14px] bg-white border border-[#CBD5E1] text-[#0F172A] text-xs font-bold hover:bg-[#F8FAFC] flex items-center gap-1.5 cursor-pointer">
          ...
          <button
            ...
            className="os-brand-btn h-[40px] px-4 rounded-[14px] font-bold text-xs flex items-center gap-1.5 cursor-pointer"
      ...
      <main className="p-[24px_26px_30px] space-y-5 flex-1">
        ...
        {/* Client Roster Table */}
        <Card padding="p-0" className="overflow-hidden flex-none border border-[#E2E8F0] bg-white">
          {/* Table Header */}
