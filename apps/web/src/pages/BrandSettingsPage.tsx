...
import { Eyebrow, Card, BookingLinkField } from '@unclutteros/ui';
    ...
    <div className="flex-1 min-w-[1192px] flex flex-col bg-[#F8FAFC]">
      <header className="h-[80px] bg-white border-b border-[#E2E8F0] px-[26px] flex items-center justify-between gap-5 shrink-0">
        <div>
          ...
          <h1 className="text-[20px] font-bold tracking-[-0.02em] text-[#0F172A]">Brand & Custom Domain Settings</h1>
        </div>
        <BookingLinkField url={bookingUrl} className="ml-auto" />
      </header>

      <main className="p-[24px_26px_30px] grid grid-cols-12 gap-6 items-start flex-1">
